 ...
 * deploy rotates those names — measured on this repository, editing four files
 * rotated 123 of 534 chunk filenames, because a chunk's name is written
 * literally into its importers' import statements and the rename cascades
 * upward. The file the open tab then asks for is no longer served.
 *
