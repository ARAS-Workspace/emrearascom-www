...
export default defineConfig({
  plugins: [
    ...
    // live, the edge's brotli body was 12-33% larger than the stored .br for
    // the same URL, proving the sidecars were never read. They were 62% of
    // dist's file count and bought nothing.
  ],
  server: {
    port: 5173,
    open: false,
    // HTTPS with custom certificate for www.emrearas.com
