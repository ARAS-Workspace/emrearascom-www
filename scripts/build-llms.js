...
function fullHeader(locale, pageCount) {
  ...
  return [
    '# Rıza Emre ARAS',
    '',
    '> **Full site content — every page that ships an llms.txt, in a single file.**',
    '>',
    `> **EN:** All ${pageCount} pages of emrearas.com (the CV, the AI page and every blog post),`,
    ...
    '> Interactive components (diagrams, figures, the chat widget) are replaced by their',
    '> source data or a short directive — read those as data pointers, not missing',
    '> content.',
    '>',
    `> **TR:** emrearas.com'un ${pageCount} sayfasının tamamı (özgeçmiş, AI sayfası ve tüm blog`,
    ...
    '> ayracı DEĞİLDİR. İnteraktif bileşenler (diyagram, görsel, sohbet aracı)',
